...
Channel.fromPath("$baseDir/assets/where_are_my_files.txt")
       .into{ch_where_star; ch_where_hisat2; ch_where_hisat2_sort; ch_where_tophat2}
...
// permet de fournir a Star comme entree :
// soit le channel de sortie de rRNA mapping (si annotations fournies)
// soit la channel de lecture des reads fournis en entrée
star_raw_reads_choix = Channel.create()
if( params.rrna ){
    star_raw_reads_choix = rrna_mapping_res
}
else {  
    star_raw_reads_choix = raw_reads_star
}
...
if(params.aligner == 'star'){
    ...
    process star {
        ...
        input:
        set val(name), file(reads) from star_raw_reads_choix
...
// permet de fournir a Hisat2 comme entree :
// soit le channel de sortie de rRNA mapping (si annotations fournies)
// soit la channel de lecture des reads fournis en entrée
