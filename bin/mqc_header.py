...
parser.add_argument("-w", "--warn", help="Warnings file to display", type=str, default=None)
...
if re.match(r".*dev(el)?$", args.version):
    report_comment+=" This software is currently under active development and the results have been generated with a non stable version. The reliability, reproducibility and the quality of the results are therefore not guaranteed.<br>"
